...
@Database(entities = {ExerciseDay.class , Plan.class , Detail.class, Exercise.class , DayProgressModel.class, User.class, Record.class, Reminder.class}, version = 1,exportSchema = false)
